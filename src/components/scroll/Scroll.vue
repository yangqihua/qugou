...
//      },
    ...
    mounted() {
//    	this.initListWrapperClass();
      setTimeout(() => {
        this.initScroll()
      }, 20)
    },
    methods: {
//      initListWrapperClass(){
//        this.$refs.wrapper.style.top = this.listWrapperTop+'px';
//        this.$refs.wrapper.style.bottom = this.listWrapperBottom+'px';
//      },
      initScroll() {
